...
let transporter = nodemailer.createTransport({
  host: "kestrelexpress.com",
  port: 465,
  secure: true, 
  auth: {
    user: 'development@kestrelexpress.com',
    pass: 'Musikana20#', 
  },
  tls: {
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              <tr>
                <td align="center" valign="top" style="padding: 36px 24px;">
                  <a href="https://www.kestrelexpresscom" target="_blank" style="display: inline-block;">
                    <img src="https://kestrelexpress.com/static/images/logo.jpg" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                  </a>
                </td>
              </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    ...
                    <p style="margin: 0px 0px 15px 0px;">
                    Your verification code is KE${code}.
                    </p>
                    ...
                    <p style="margin: 0px 0px 15px 0px;">
                    If you have any questions, send us an email info@kestrelexpress.com.
                    </p>
